...
df = pd.read_csv('ReviewsIIFL.csv')
...
st.markdown('<h1 style="font-size: 70px; color: #E3142D;"> IIFL </h1>',
...
if filterdata:
    ...
    def clean_words(new_tokens, custom_stop_words={'iifl', 'please', 'able', 'bank', 'app', 'good', 'nice', 'best'}):
